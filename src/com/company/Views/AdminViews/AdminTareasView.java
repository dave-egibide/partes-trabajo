        ...
        try {
            ...
            if (tarea == null) {
                ...
                if (!error.isEmpty()) {
                    ...
                    tarea.setNombre(StringUtils.left(StringUtils.capitalize(textFieldVal2.getText().trim().toLowerCase()), 20));
                    tarea.setDescripcion(StringUtils.left(StringUtils.capitalize(descripcionTextField.getText().trim().toLowerCase()), 200));
